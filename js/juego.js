...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 160, 260, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 460, 290, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 780, 180, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 240, 390, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 840, 380, 15, 30, 1)
  ],
